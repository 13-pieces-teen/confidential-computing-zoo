...
面向 AAMAS 2027 EMAS 的写作结构见 [Argus 论文框架](./论文/Argus-AAMAS2027-EMAS-论文框架.md)：包含已确认的研究问题、候选贡献、章节与图表计划、8 页篇幅建议、正式录用论文的结构借鉴和当前证据边界；它是写作框架，不是初稿或新增验收结论。

独立的[论文整体思路与候选想法](./论文/Argus-EMAS-论文整体思路与候选想法-2026-09-12.md)沿用原主线，讨论整篇的价值、贡献与比较；将证明状态参与 Agent 后续抉择、按需核验等记录为候选想法，不替代论文框架。

最新的[跨企业协作 Intro 草稿与配图](./论文/Argus-EMAS-Intro-跨企业可信服务协作-2026-09-12.md)以 Bosch 式联合研发和跨银行融资核验展开资源依赖、服务方动机及实际实例核验，包含可继续打磨的引言正文和 SVG／PNG 流程图。案例映射为拟议设计，原论文框架及三项候选贡献保持不变。
