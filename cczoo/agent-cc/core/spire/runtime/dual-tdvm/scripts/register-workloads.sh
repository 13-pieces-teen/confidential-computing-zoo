...
openviking_digest="${DUAL_OPENVIKING_IMAGE_CONFIG_DIGEST:-$(
    remote_image_digest openviking "$OPENVIKING_SSH_TARGET" "$OPENVIKING_IMAGE"
)}"
...
spire_server entry show -entryID dual-openviking-workload
